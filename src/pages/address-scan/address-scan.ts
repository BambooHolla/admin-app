...
import { IonicPage, NavController, NavParams, AlertOptions, ViewController } from 'ionic-angular';
...
import { PAGE_STATUS } from '../../app-framework/const';

/**
 * Generated class for the AddressScanPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */

@IonicPage({name: "page-address-scan"})
@Component({
  selector: 'page-address-scan',
  templateUrl: 'address-scan.html',
})
export class AddressScanPage extends SecondLevelPage {
  ...
  private titleContent = "扫描二维码";
  @AddressScanPage.willEnter
  initParams() {
  ...
  @asyncCtrlGenerator.error(
    "扫描异常",
    async function(self: AddressScanPage) {
      return {
        closeButton: false,
        buttons: [
          {
  ...
  // @asyncCtrlGenerator.error("关注地址失败")
  // @asyncCtrlGenerator.success("地址关注成功")
